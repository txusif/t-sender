  ...
  return (
    <nav className="px-8 py-4.5 border-b-[1px] border-zinc-100 flex flex-row justify-between items-center bg-white xl:min-h-[77px]">
      ...
      <div className="flex items-center gap-4">
        <ConnectButton />
        <a
          href="https://github.com/txusif/t-sender"
          target="_blank"
          rel="noopener noreferrer"
          className="p-1 rounded-lg bg-zinc-900 hover:bg-zinc-800 transition-colors border-2 border-zinc-600 hover:border-zinc-500 hidden md:block cursor-pointer"
        >
